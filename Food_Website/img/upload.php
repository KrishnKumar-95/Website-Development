...
<body>
	<div class="container">
		...
		$con = mysqli_connect('localhost','indiand1_krishn','Krishn@951829');
		...
		if(isset($_POST['submit'])) {
			...
			if(in_array($pdffilecheck,$pdffileextstored)) {
				$pdfdestinationfile = 'upload/'.$pdffilename;
				move_uploaded_file($pdffiletmp,$pdfdestinationfile);
				
				// $q = "INSERT INTO `imgupload`(`username`, `fathername`, `mothername`, `dob`, `image`) VALUES ('$username','$fathername','$mothername','$dob','$destinationfile')";
				
				$q = "INSERT INTO `imgupload`(`username`,
				                              `fathername`,
				                              `mothername`,
				                              `dob`,
				                              `gender`,
